...
function addTab(subtitle, url, icon, menuid) {
	...
	if(!$('#tabs').tabs('exists',subtitle)){
	    $('#tabs').tabs('add', {
			title:subtitle,
			content: createFrame(url, "limitid__"+menuid),
			closable:true,
			icon:icon
		});
	}else{
...
{
	var s = '<iframe scrolling="auto" id="'+id+'" frameborder="0"  src="'+url+'" style="width:100%;height:99%;padding-top:1px"></iframe>';
	return s;
}
